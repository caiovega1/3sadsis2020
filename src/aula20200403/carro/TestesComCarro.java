...
class TestesComCarro {
	...
	void testeEsvaziarTanque() {
		Carro monza3633 = new Carro(10.00);
		Carro opala53A54 = new Carro(10.00);
		
		monza3633.esvaziarTanque();
		opala53A54.esvaziarTanque();

		assertEquals(0, monza3633.getCombustivelNoTanqueEmLitros());

		assertEquals(0, opala53A54.getCombustivelNoTanqueEmLitros());
	}
